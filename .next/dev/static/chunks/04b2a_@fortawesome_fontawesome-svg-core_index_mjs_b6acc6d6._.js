...
"[project]/node_modules/.pnpm/@fortawesome+fontawesome-svg-core@7.1.0/node_modules/@fortawesome/fontawesome-svg-core/index.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function _classCallCheck(a, n) {
    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_instanceof$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(a, n)) throw new TypeError("Cannot call a class as a function");
}
...
function _toPrimitive(t, r) {
    if ("object" != (typeof t === "undefined" ? "undefined" : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(t)) || !t) return t;
    var e = t[Symbol.toPrimitive];
    if (void 0 !== e) {
        var i = e.call(t, r || "default");
        if ("object" != (typeof i === "undefined" ? "undefined" : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(i))) return i;
...
function _toPropertyKey(t) {
    ...
    return "symbol" == (typeof i === "undefined" ? "undefined" : (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(i)) ? i : i + "";
}
function _typeof(o) {
    ...
    return _inherits(BabelRegExp, RegExp), BabelRegExp.prototype.exec = function(r) {
        ...
        if ("string" == typeof p) {
            ...
            return e[Symbol.replace].call(this, t, p.replace(/\$<([^>]+)(>|$)/g, function(e, r, t) {
                if ("" === t) return e;
                var _$p = o[r];
                return Array.isArray(_$p) ? "$" + _$p.join("$") : "number" == typeof _$p ? "$" + _$p : "";
            }));
        }
        if ("function" == typeof p) {
            ...
            return e[Symbol.replace].call(this, t, function() {
                var e = arguments;
                return "object" != (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$swc$2b$helpers$40$0$2e$5$2e$15$2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_type_of$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(e[e.length - 1]) && (e = [].slice.call(e)).push(buildGroups(e, i)), p.apply(this, e);
            });
        }
...
var mutators = {
    ...
    nest: function nest(mutation) {
        ...
        delete _abstract[0].attributes.id;
        if (_abstract[0].attributes["class"]) {
            var splitClasses = _abstract[0].attributes["class"].split(' ').reduce(function(acc, cls) {
            ...
            _abstract[0].attributes["class"] = splitClasses.toSvg.join(' ');
        ...
        var newInnerHTML = _abstract.map(function(a) {
            return toHtml(a);
        }).join('\n');
...
var ReplaceElements = {
    ...
    provides: function provides(providers$$1) {
        providers$$1.i2svg = function(params) {
            var _params$node = params.node, node = _params$node === void 0 ? DOCUMENT : _params$node, _params$callback = params.callback, callback = _params$callback === void 0 ? function callback() {} : _params$callback;
        ...
        if (alreadyProcessedPseudoElement && !fontFamilyMatch) {
            ...
            if (iconName && !isSecondary && (!alreadyProcessedPseudoElement || alreadyProcessedPseudoElement.getAttribute(DATA_PREFIX) !== prefix || alreadyProcessedPseudoElement.getAttribute(DATA_ICON) !== iconIdentifier)) {
                ...
                findIcon(iconName, prefix).then(function(main) {
                    ...
                    element.outerHTML = _abstract.map(function(a$$1) {
                        return toHtml(a$$1);
                    }).join('\n');
...
function deGroup(_abstract) {
    if (_abstract.tag === 'g') {
        return _abstract.children;
    } else {
        return [
            _abstract
        ];
...
//# sourceMappingURL=04b2a_%40fortawesome_fontawesome-svg-core_index_mjs_b6acc6d6._.js.map